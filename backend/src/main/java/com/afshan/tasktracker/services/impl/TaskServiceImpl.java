...
import com.afshan.tasktracker.repositories.TaskRepository;
...
public class TaskServiceImpl implements TaskService {
    ...
    // because task service needs TaskListRepository to verify parent exists
    ...
    // if task priority null use MEDIUM
