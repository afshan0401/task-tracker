package com.afshan.tasktracker.domain.entity;
...
public class Task {
    ...
    //specifies foreign key column name in the Task table
    //column in Task table, containing the id of the TaskList to which the task belongs
    //CHILD ENTITY
